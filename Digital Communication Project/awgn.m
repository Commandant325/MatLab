...
%
%
noiseHamming = randn(size(normalizedFSKSignalHamming));
noiseNoHamming = randn(size(normalizedFSKSignalNoHamming));
%%
for k = 1 : SNRLength
%%
	receivedSignalHamming = normalizedFSKSignalHamming + noiseHamming / sqrt(SNR(k));
	receivedSignalNoHamming = normalizedFSKSignalNoHamming + noiseNoHamming / sqrt(SNR(k));
	complexSignalHamming = receivedSignalHamming;
%%
...
%%
	complexSignalNoHamming = receivedSignalNoHamming;
%%
